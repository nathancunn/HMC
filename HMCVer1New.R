...
JJ <- HMCVer1(TotalSamples = 1,densityA = function(l) dmvnorm(l,c(0,0),matrix(c(1,0.9,0.9,1),2,2)),q = c(0,0),M=diag(2),epsilon = 0.05,L = 60,densitydiff = function(x) {solve(matrix(c(1,0.9,0.9,1),2,2))%*%as.matrix(x)}, burnin = 0)
